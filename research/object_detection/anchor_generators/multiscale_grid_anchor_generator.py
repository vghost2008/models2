...
class MultiscaleGridAnchorGenerator(anchor_generator.AnchorGenerator):
  ...
  def _generate(self, feature_map_shape_list, im_height=1, im_width=1):
    ...
    boxes = anchor_grid_list[0].data['boxes'][19200:19216]

    anchor_grid_list[0].data['boxes'] =tf.Print(anchor_grid_list[0].data['boxes'],[boxes],name=name+"_anchorboxes",summarize=-1)'''
    #####
