  ...
  def _extract_proposal_features(self, preprocessed_inputs, scope):
    ...
    with tf.control_dependencies([shape_assert]):
      ...
      with slim.arg_scope(
        ...
        preprocessed_inputs = tf.Print(preprocessed_inputs,[tf.reduce_max(preprocessed_inputs),tf.reduce_min(preprocessed_inputs),tf.reduce_mean(preprocessed_inputs)],name="Preprocessed_image")
